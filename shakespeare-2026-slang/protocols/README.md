...
3. Use integrated contemporary lexical reconstruction rather than sparse decorative slang insertion.
4. Use the project slang glossary as the primary lexical evidence base.
5. Permit separately supported current slang only when its evidentiary status is identified.
6. Rebuild surrounding syntax when necessary to accommodate contemporary vocabulary.
7. Mark slang and substantial accommodation language visibly in working editions.
8. Annotate major interventions by source function, replacement, rationale, equivalence strength, evidence status, and prosodic treatment.
9. Maintain recurring lexical systems.
10. Maintain scene and cumulative corpus counts.
...
- metaphor-chain preservation
- character idiolect matrices
- rhetorical-figure preservation
- multiaxial fidelity scoring
- back-translation / information-retention testing
- nuance-loss registers
- slang half-life ratings
- iconic-line thresholds
- dramatic-irony protection
- power / consent / coercion checks
- performance testing
- scene beat mapping
- modernization-intensity scaling
- pun / wordplay reconstruction
- cultural-reference transformation rules
- lexical-saturation controls
- formal Nuance Audits
